        ...
        @foreach($classSchedulings as $classScheduling)
            ...
            <td>@if( $classScheduling->status == 1)
                ...
                <td>
                    ...
                    <a data-toggle="modal" data-target="#Editclassschedule-show" id="Edit" data-id="{{$classScheduling->schedule_id}}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
